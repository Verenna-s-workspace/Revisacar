...
export function StartScreen({ adminNome, onLogout, onStartNew, onLoadRascunho }: StartScreenProps) {
  ...
  const handleDeleteRascunho = async (id: string, e: MouseEvent) => {
  ...
  const authHeader = (
    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '30px' }}>
      <div>
        <p style={{ margin: 0, color: tokens.color.textMuted, fontSize: '0.95rem' }}>Olá, {adminNome}</p>
        <h1 style={{ margin: '6px 0 0', color: tokens.color.text }}>RevisaCar</h1>
      </div>
      <button
        onClick={onLogout}
        style={{
    ...
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: tokens.color.surface }}>
      <div style={{ textAlign: 'center', maxWidth: '500px' }}>
        ...
        <div style={{ marginBottom: '40px' }}>
          <p style={{ margin: 0, color: tokens.color.textMuted }}>admin: {adminNome}</p>
        </div>
