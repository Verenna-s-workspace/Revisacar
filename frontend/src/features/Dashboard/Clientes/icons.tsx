// Ícones usados apenas na tela de Clientes. Seguem o mesmo estilo dos demais
// conjuntos de ícones do dashboard (stroke currentColor, viewBox 24x24) —
// ver `features/Dashboard/Icons.tsx` e `features/Dashboard/Veiculos/icons.tsx`.
...
export const ClienteIcons = {
  ...
  packageCheck: (
    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M21 10V7a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 7v10a2 2 0 0 0 1 1.73l6 3.44" />
