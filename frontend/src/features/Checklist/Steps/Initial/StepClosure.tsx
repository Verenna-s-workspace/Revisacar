...
export function Step3({ os, onExportPDF, onNextChecklist }: StepProps) {
  const {
    veiculo,
    cliente,
    photos,
        ...
        <div style={grid4}>
          ...
          <Field label="Parecer geral" span={4}>
            <Textarea
              ...
              onChangeValue={(v) =>
                setTecnico((p) => ({ ...p, parecer_geral: v }))
              }
            />
          </Field>
        </div>
        ...
        right={
          <>
            ...
            <button onClick={saveOrder} style={btnSolid}>
             ...
             <button onClick={onNextChecklist} style={btnAccent}>
              <svg
                width={11}
                height={11}
                viewBox="0 0 640 640"
                ...
                strokeLinejoin="round"
              >
                <path d="M384 96H544V256" />
                <path d="M512 128L288 352" />
                <path d="M144 192H224" />
                <path d="M448 416V496C448 522.5 426.5 544 400 544H144C117.5 544 96 522.5 96 496V240C96 213.5 117.5 192 144 192H224" />
              </svg>
              Próxima etapa
            </button>
