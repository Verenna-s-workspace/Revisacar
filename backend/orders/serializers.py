...
class TecnicoSerializer(serializers.Serializer):
    nome = serializers.CharField(default="")
    registro = serializers.CharField(default="")
    data_saida = serializers.CharField(default="")
    hora_saida = serializers.CharField(default="")
    km_saida = serializers.CharField(default="")
    parecer_geral = serializers.CharField(default="")
